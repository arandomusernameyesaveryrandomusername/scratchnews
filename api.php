...
<main>
    ...
    <p>A small, read-only API for building things on top of ScratchNews — Discord bots, dashboards, whatever you want.
        Access is IP-based and closed by default. If you want in, reach out on <a href="https://discord.gg/YOUR_INVITE_HERE">Discord</a> with the IP address you'll be calling from.</p>
